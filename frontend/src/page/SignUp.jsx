    ...
    return (
        ...
        >
            <div className='aspect-square text-teal-50 w-full lg:w-[70%] sm:p-5 flex items-center flex-col justify-center gap-7 rounded-lg m-4  '>
                ...
                <div className='w-[90%] bg-pink sm:w-[60%] md:w-[50%] p-4 py-6 lg:w-[40%] border'>
                    <form
                        ...
                        <label className="input input-bordered flex items-center gap-2">
                            ...
                            <input {...register("name")} type="text" className="grow" placeholder="Full Name" />
                        </label>
                        <label className="input input-bordered flex items-center gap-2">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div className='text-center'>
                            <button className='px-2 py-1 bg-slate-600 max-w-min rounded-lg font-roboto'> Register</button>
                        </div>
                    </form>
                </div>
            </div>
